/**
 * contain all facebook signup and login routes
 * ### Usage:
 *```
 ...
 * 
 * @module Routes FacebookSignSystem
 */
'use strict'
...
/**
 * set the facebook signing & callback route
 * @method
...
export const router = (passport) => {
    ...
    router.get('/auth/facebook', (req, res, next) => {
        ...
        if (req.headers.referer && process.env.ALLOWED_SOCIAL_LOGIN_REDIRECT_LIST.includes(req.headers.referer)) {
            ...
            passport.authenticate('facebook', { state: req.headers.referer })(req, res, next);
        } else {
